...
escrever_ou_apagar:
	...
	NOT R6 ; Nega novamente a mascara para saber se esta desenhado ou nao
	AND R8, R6 ; Testa R8 para ver se pode desenhar no pixel escolhido
	JZ fim_desenhar_pixel ; Se for 0 nao pode desenhar o pixel 
	JMP acaba_desenhar_pixel ; Acaba de desenhar o pixel
escrever:
	OR R8, R6 ; Cria a mascara com o bit final a desenhar
acaba_desenhar_pixel:
